 ...
 */
 ...
 import VxlanPlusMinus from "./VxlanPlusMinus";
 import ARPPlusMinus from "./ARPPlusMinus";
 ...
 class Content extends Component {
   constructor(props) {
     ...
     this.handleVxlanAdd = this.handleVxlanAdd.bind(this);
     this.handleVxlanMinus = this.handleVxlanMinus.bind(this);
 
     this.handleARPAdd = this.handleARPAdd.bind(this);
     this.handleARPMinus = this.handleARPMinus.bind(this);
   ...
   handleARPAdd() {
     if (this.state.arpLinkClicked >= 0) {
   ...
   handleARPMinus() {
     if (this.state.arpLinkClicked > 0) {
       MY_GLOBAL.headersSelected.splice(
         MY_GLOBAL.headersSelected.lastIndexOf("ARP"),
         1
       );
       let tempArray = [...this.state.headersCheckboxed];
       tempArray.splice(tempArray.length - 1, 1);
                 ...
                 >
                   <table style={{ width: "75%", margin: "0 auto" }}>
                     <tbody>
                       ...
                       />
                       <VxlanPlusMinus
                         minusAction={this.handleVxlanMinus}
                         plusAction={this.handleVxlanAdd}
                       />
                       <ARPPlusMinus
                         minusAction={this.handleARPMinus}
                         plusAction={this.handleARPAdd}
                       />
                     </tbody>
                   </table>
                 </Row>
